...
def main():
    ...
    load_dotenv()
    endpoint = os.getenv("ENDPOINT") #this is supposed to foundry endpoint
    analyzer_id = os.getenv("ANALYZER") #this is analyzer id from content understanding studio, here schema is already been created and published, so we can use it to analyze the image
