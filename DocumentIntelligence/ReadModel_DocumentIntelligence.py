...
"""
endpoint = "https://documentintelligenceresourcetestbycode.cognitiveservices.azure.com/"
key = "<YOUR_KEY>" 
# Get the endpoint and key from the azure portal -> document intelligence resource -> keys and endpoint
